...
model = MeshNeuralNetwork(HIDDEN_UNITS, OUTPUT, num_ticks=TICKS, use_bias=True,
                 activation=tf.nn.relu,kernel_initializer=tf.initializers.RandomUniform(minval=0,maxval=1,seed=SEED))
